<template>
  <q-page padding>
    ...
    <ul>
      ...
      <li>
        <p>
          ...
          the Company downloaded by You on any electronic device, named Brunei
          Sign Languange
        </p>
      </li>
      <li>
        <p>
          ...
          this Agreement) refers to Brunei Sign Language.
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p><strong>Country</strong> refers to: Brunei</p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <strong>Website</strong> refers to Brunei Sign Language, accessible
          from
          <a
            href="https://bruneisignlanguage.netlify.app"
            rel="external nofollow noopener"
            target="_blank"
            >https://bruneisignlanguage.netlify.app</a
          >
        </p>
      </li>
      <li>
    ...
    <ul>
      <li>By email: qoyyuum@duck.com</li>
    </ul>
  </q-page>
</template>
